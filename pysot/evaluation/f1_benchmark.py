...
class F1Benchmark:
    ...
    def eval(self, eval_trackers=None):
        ...
        for tracker_name in eval_trackers:
            ...
            ret[tracker_name] = {"precision": precision, "recall": recall, "f1": f1}
        return ret
    ...
    def show_result(self, result, show_video_level=False, helight_threshold=0.5):
        ...
        for tracker_name, ret in result.items():
            ...
            sorted_tracker[tracker_name] = (precision[max_idx], recall[max_idx], f1[max_idx])
        sorted_tracker_ = sorted(sorted_tracker.items(), key=lambda x: x[1][2], reverse=True)[:20]
